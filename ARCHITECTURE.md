...
### [AIConsumptionTracker.Core](file:///c:/Develop/Claude/opencode-tracker/AIConsumptionTracker.Core)
...
### [AIConsumptionTracker.Infrastructure](file:///c:/Develop/Claude/opencode-tracker/AIConsumptionTracker.Infrastructure)
...
### [AIConsumptionTracker.Agent](file:///c:/Develop/Claude/opencode-tracker/AIConsumptionTracker.Agent)
...
### [AIConsumptionTracker.UI](file:///c:/Develop/Claude/opencode-tracker/AIConsumptionTracker.UI) & [AIConsumptionTracker.UI.Slim](file:///c:/Develop/Claude/opencode-tracker/AIConsumptionTracker.UI.Slim)
...
### [AIConsumptionTracker.CLI](file:///c:/Develop/Claude/opencode-tracker/AIConsumptionTracker.CLI)
The **Management Tool**.
- Provides a command-line interface `act` for users who prefer the terminal.
- Allows for scripting and headless status checks.

### [AIConsumptionTracker.Web](file:///c:/Develop/Claude/opencode-tracker/AIConsumptionTracker.Web)
