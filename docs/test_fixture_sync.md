...
- Checked-in snapshots:
  ...
  - `AIUsageTracker.Tests\TestData\Providers\github_copilot_internal_user.snapshot.json`
  - `AIUsageTracker.Tests\TestData\Providers\github_copilot_internal_v2_token_404.snapshot.json`
