...
public class UsageAnalyticsServiceTests
{
    ...
    [Fact]
    public async Task GetBurnRateForecastsAsync_WithEmptyProviderIds_ReturnsEmptyAsync()
    {
    ...
    [Fact]
    public async Task GetProviderReliabilityAsync_WithEmptyProviderIds_ReturnsEmptyAsync()
    {
        var service = new UsageAnalyticsService(this._mockRepo.Object, this._cache, NullLogger<UsageAnalyticsService>.Instance);
    ...
    [Fact]
    public async Task GetUsageAnomaliesAsync_WithEmptyProviderIds_ReturnsEmptyAsync()
    {
        var service = new UsageAnalyticsService(this._mockRepo.Object, this._cache, NullLogger<UsageAnalyticsService>.Instance);
