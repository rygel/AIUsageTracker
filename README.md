...
<img width="300" height="646" alt="image" src="https://github.com/user-attachments/assets/38e0deac-5610-46b6-85e1-2f32cff4b0e2" />
...
### Manual
1. Download the latest `AIConsumptionTracker_Setup_v1.5.3.exe` from the [Releases](https://github.com/rygel/AIConsumptionTracker/releases) page.
2. Run the installer.
