    ...
    public class OpenRouterProvider : ProviderBase
    {
        ...
        public override async Task<IEnumerable<ProviderUsage>> GetUsageAsync(ProviderConfig config, Action<ProviderUsage>? progressCallback = null)
        {
            ...
            try
            {
                ...
                {
                    this._logger.LogError("OpenRouter credits API failed with status {StatusCode}. Response: {Response}",
            ...
            catch (Exception ex)
            {
                ...
                return new[] { this.CreateUnavailableUsageFromException(
                    ex,
            ...
            this._logger.LogInformation("OpenRouter usage calculated - Total: {Total}, Used: {Used}, Remaining: {Remaining}, RemainingPercentage: {RemainingPercentage}%",
