                ...
                try
                {
                    ...
                    if (rawConfigs != null)
                    {
                        foreach (var kvp in rawConfigs)
                        {
                            ...
                            if (element.TryGetProperty("key", out var keyProp)) key = keyProp.GetString() ?? string.Empty;
                            
                            string type = "api";
                            if (element.TryGetProperty("type", out var typeProp)) type = typeProp.GetString() ?? "api";
